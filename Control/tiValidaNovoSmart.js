...
$(document).ready( function(){
	...
	$('#criarNovoSmart').click(function() {
		...
		$.ajax({
		    ...
		    type:'GET',
		    url:"../Control/tiInsertSmart?command=insert&id_smart="+$('#recipient-id_smart').val()+"&imei="+$('#recipient-imei').val()+"&pulsus="+$('#recipient-pulsus').val()+"&id_origem="+$('#recipient-origem').val(),
