...
<html>
  ...
  <meta charset="UTF-8"/>
    ...
    <link rel="SHORTCUT ICON" href="../imagem/iconelink.ico">
      ...
      <!-- Faz referência a arquivo .js personalizado -->
      <script type="text/javascript"  src="../Control/tiValidaOrigem.js"></script>
      ...
      <link rel="stylesheet" href="../css/teamplateTiCadastroOrigem.css" >
...
<!-- Tela Cadastro Origem - Start -->
      <div class="modal-dialog" role="document" id="controleSmartModal">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLabel">Cadastrar Nova Origem</h3>
          </div>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label  for="recipient-origem" class="col-form-label">Digite o Nome da Origem que Deve ser Cadastrada</label>
            <input  type="text" class="form-control" id="recipient-origem">
          </div>
          <!-- Campo Origem - End -->
          ...
          <div class="modal-footer">
            ...
            <button type="button"  class="btn btn-secondary" id="criarOrigem">Cadastrar</button>           
          </div>
          <!-- Botão Cadastrar - End -->
