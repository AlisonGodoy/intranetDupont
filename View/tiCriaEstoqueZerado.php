...
<html>
  ...
  <meta charset="UTF-8"/>
    <title>Novo Smarts</title>
      ...
      <!-- Faz referência a arquivo .js personalizado -->
      <script type="text/javascript"  src="../Control/tiValidaEstoqueZerado.js"></script>
      ...
      <div class="modal-dialog" role="document" id="novoSmartModal">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input style="display: none;" type="number" class="form-control" id="recipient-id_smart" value=<?php echo $id;?>>
          </div>
          <!-- Campo ID Smart - End -->
          ...
          <div class="form-group">
            ...
            <input type="text" maxlength="15" pattern="([0-9]{3})" class="form-control" id="recipient-imei">
          </div>
          <!-- Campo IMEI - End -->
          ...
          <div class="modal-footer">
            <a href="../View/tiEstoqueZerado.php"><button type="button"  class="btn btn-secondary" id="voltar">Voltar</button></a>
            <button type="button"  class="btn btn-secondary" id="criarEstoqueZerado">Cadastrar</button>           
          </div>
          <!-- Botão Cadastrar - End -->
